			...
			$.ajax({
				...
				success : function(response) {
					...
					if (response.success) {
						...
						$('#contact-form-response').html('<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Thank you</strong> Your message has been delivered</div>');
					}

					$.each(response.error, function(i, val) {
						$('#contact-form-response').append('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Warning!</strong> ' + val + '</div>');
					})

					$("#contact-submit").html("<i class='fa fa-check'></i> SUBMIT").prop('disabled', false);
				},
				error : function() {
					$('#contact-form-response').empty().html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><strong>Warning!</strong> Something went wrong!</div>');
				}
			});
			return false;
		});
